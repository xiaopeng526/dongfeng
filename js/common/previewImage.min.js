! function(e, t) {
	...
	return i.prototype.start = function(e) {
		...
		this.$text = s, this.$text.className += "previewImage-text", this.$text.innerHTML =
			"<span class='previewImage-text-index'>" + (this.index + 1) + "/</span>" + (this.maxLen + 1), this.container =
			this.imgStatusCache[this.cIndex] = {
				elem: this.$container,
				x: this.winw,
				y: 0,
				m: 0,
		...
		if (0 == this.index && -1 == e) this.index = this.index;
			...
			this.index += e, this.$text.innerHTML = "<span class='previewImage-text-index'>" + (this.index + 1) + "/</span>" +
				(this.maxLen + 1);
