...
define(function (require, exports, module) {
	...
	/* 
 	查询预审代办各节点数量
  */
	function countDealerPreTrialNum() {
		var _url = mbank.getApiURL() + 'countDealerPreTrialNum.do';
	...
	mui.plusReady(function () {
		...
		/* 点击选项卡，重新切换数据*/
		var index = 0,
		    pageNo = [{ num: 1, tabLoadEnd: false }, { num: 1, tabLoadEnd: false }, { num: 1, tabLoadEnd: false }, { num: 1, tabLoadEnd: false }];
			...
			loadUpFn: function loadUpFn(me) {
				...
				switch (index) {
					case 0:
						...
						break;
					case 1:
						queryDealerPreTriaList('YS_SQLR', 1, 1, true, searchValue);
						break;
					case 2:
						queryDealerPreTriaList('YS_ZXQS', 2, 1, true, searchValue);
						break;
					case 3:
						queryDealerPreTriaList('YS_SQTJ', 3, 1, true, searchValue);
						break;
				}
			},
			loadDownFn: function loadDownFn(me) {
				switch (index) {
					case 0:
						...
						break;
					case 1:
						queryDealerPreTriaList('YS_SQLR', 1, pageNo[1].num, false, searchValue);
						break;
					case 2:
						queryDealerPreTriaList('YS_ZXQS', 2, pageNo[2].num, false, searchValue);
						break;
					case 3:
						queryDealerPreTriaList('YS_SQTJ', 3, pageNo[3].num, false, searchValue);
						break;
				}
			},
			threshold: 50
